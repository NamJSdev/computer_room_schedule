...
<script>
    $(document).ready(function(){
        ...
        $('#editModal').on('show.bs.modal', function (event) {
            ...
            modal.find('input[name="TenPhong"]').val(name);
        });
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Danh Sách Phòng Máy</h2></div>
                    <div class="col-sm-4">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr data-id="{{ $room->id }}">
                        ...
                        <td>{{ $room->TenPhong }}</td>
                        <td>
                            <a href="#" class="edit" title="Edit" data-toggle="modal" data-target="#editModal" data-id="{{ $room->id }}" data-name="{{ $room->TenPhong }}"><i class="fas fa-fw fa-pen"></i></a>
                            <a href="#" class="delete" title="Delete" data-toggle="modal" data-target="#deleteModal" data-id="{{ $room->id }}"><i class="fas fa-fw fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
<div id="addModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="addForm" action="{{ route('add-room') }}" method="POST">
                @csrf

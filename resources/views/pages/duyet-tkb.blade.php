            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr data-id="{{ $dangKyLopHoc->id }}">
                        ...
                        <td>{{ $dangKyLopHoc->thoiKhoaBieu->GiangVien }}</td>
                        <td>
                        ...
                        <td>
                            <a title="Duyệt" href="#" class="success" title="Edit" data-toggle="modal" data-target="#editModal" data-id="{{ $dangKyLopHoc->id }}"><i class="far fa-check-circle" style="color: #63E6BE;"></i></a>
                            <a href="#" class="delete" title="Từ chối" data-toggle="modal" data-target="#deleteModal" data-id="{{ $dangKyLopHoc->id }}"><i class="far fa-times-circle"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
<div id="editModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="editForm" action="{{ route('approve-tkb-admin') }}" method="POST">
                @csrf
                <div class="modal-header">						
                    <h4 class="modal-title">Bạn có chắn chắn muốn duyệt thời khóa biểu này?</h4>
...
<div id="deleteModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deleteForm" action="{{ route('reject-tkb-admin') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h4 class="modal-title">Bạn chắc chắn muốn từ chối duyệt thời khóa biểu này?</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
